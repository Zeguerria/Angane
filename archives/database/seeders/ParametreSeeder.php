...
class ParametreSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table("parametres")->insert([
			...
			["id"=> 57, "code" => "PK5",  "libelle" => "PK5", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 58, "code" => "PK6",  "libelle" => "PK6", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 59, "code" => "PK7",  "libelle" => "PK7", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 60, "code" => "PK8",  "libelle" => "PK8", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 61, "code" => "PK9",  "libelle" => "PK9", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 62, "code" => "PK10",  "libelle" => "PK10", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 63, "code" => "PK11",  "libelle" => "PK11", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 64, "code" => "PK12",  "libelle" => "PK12", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 65, "code" => "NDZENG",  "libelle" => "NDZENG AYOBG", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 66, "code" => "CHARBO",  "libelle" => "CHARBONNAGE", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 67, "code" => "RIO",  "libelle" => "RIO", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 68, "code" => "NKEM",  "libelle" => "NKEMBO", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 69, "code" => "AVEA",  "libelle" => "AVEA", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 70, "code" => "GARE",  "libelle" => "GAROUTIERE", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 71, "code" => "BELV1",  "libelle" => "BELLE VUE 1", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 72, "code" => "BELV2",  "libelle" => "BELLE VUE 2", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 73, "code" => "IAI",  "libelle" => "IAI", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 74, "code" => "ACAE",  "libelle" => "ACAE", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 75, "code" => "MIND1",  "libelle" => "MINDOUBE 1", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 76, "code" => "MIND2",  "libelle" => "MINDOUBE 2", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 77, "code" => "AWEN",  "libelle" => "AWENDJE", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 78, "code" => "BLVD",  "libelle" => "BOULEVARD", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 79, "code" => "BPEINT",  "libelle" => "BELLE PEINTURE", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
			["id"=> 80, "code" => "GARE",  "libelle" => "GAROUTIERE", "desc" => "", "parent_id" => 24, "type_parametre_id" => 5],
