                    ...
                    <div class="card-box pd-10 height-100 mb-10" >
                        <div class="row align-items-center" >
                            ...
                            <div class="col-md-10">
                                ...
                                <p class="font-18 max-width-600" style="font-size: 20px; color: var(--color-t); font-family : 'Times New Roman', Times, serif;">Vous etes connecté en tant {{--{{Auth::user()->profil->libelle}} --}}, et disposez donc tous les droits de {{--{{Auth::user()->profil->libelle}}--}} !<br> Alors Mr,Mdme {{--{{Auth::user()->name}} {{Auth::user()->prenom}}--}} ,Par quoi commencons-nous ?</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-2">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number" _msttexthash="27846" _msthash="141" style="color: var(--titre-couleur); font-family: italic; font-size:18px;"></span>
                        </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-2">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number" _msttexthash="36231" _msthash="137" style="color: var(--titre-couleur); font-family: italic; font-size:18px;"></span>
                        </div>
                        <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-12 col-sm-6 col-md-2">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number" _msttexthash="16237" _msthash="139" style="color: var(--titre-couleur); font-family: italic; font-size:18px;"></span>
                        </div>
                        </div>
                    </div>
                </div>
