...
{{-- intgration du titre --}}
@section("titre")
    Suppression du type de parametre
@endsection
...
@section('corps')
    <div class="page-header">
        <div class="page-title">
            <h4>Parametrage</h4>
            <h6>Suppression du type de parametre</h6>
        </div>
        <div class="page-btn">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('supprimerTypeParametre') }}" method="POST" enctype="multipart/form-data">@csrf
                    ...
                    <div class="col-lg-12">
                        <center>
                            <button type="submit" class="btn btn-danger me-2">
                                ...
                                SUPPRESSION LE TYPE DE PARAMETRE
                            </button>
                        </center>
                    </div>
                </div>
